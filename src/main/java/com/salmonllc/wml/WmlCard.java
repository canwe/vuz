...
public class WmlCard extends JspContainer {
    ...
    private String _onenterforward,_onenterbackward,_ontimer;
    private boolean _newcontext,_ordered=true;
    private DataStoreEvaluator _dsForwardEval,_dsBackwardEval,_dsTimerEval;
    private String _forwardDatasource,_backwardDatasource,_timerDatasource;

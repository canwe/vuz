...
/////////////////////////
//$Archive: /SOFIA/SourceCode/com/salmonllc/xml/XMLStoreParser.java $
//$Author: Len $
//$Revision: 28 $
//$Modtime: 6/17/03 2:14p $
/////////////////////////
/**
 * The XML Store paser is used to parse any XML file specified as datastore.dtd file.
 */
import java.io.*;

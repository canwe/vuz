...
/////////////////////////
/**
 * The XML Datastore is used to store any XML file or data from datastore.
...
/**
 * Gets the ResultSetData for the XML file read
...
/**
 * Gets the ResultSetMetaData (Column definition) for the XML file read
 * Creation date: (8/7/01 11:59:16 AM)

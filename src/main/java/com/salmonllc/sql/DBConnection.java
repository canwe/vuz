 ...
 * The constructor for this class is private. The only way to get an instance of the class is to use one of the static "getConnection" methods shown below.<BR><BR>
 * An important note:<BR>
 * In order for connection pooling to operate properly, the connection must be released when it is no longer needed.<BR><BR>
 * Example usage:<BR>
 *			<pre>
...
public class DBConnection {
	...
	private String _application,_profileName;
	 ...
	 * @see DBConnection#rollback
	 */
	public void beginTransaction(String fromWhere) throws SQLException {
	 ...
	 * @exception SQLException
	 */
	public static synchronized DBConnection getConnection(int maxConnections, long waitTimeout, long idleTimeout, String DBMS, String jdbcDriver, String databaseURL, String userID, String password, String dbName, String connectionParms) throws SQLException {
	 ...
	 * @exception SQLException
	 */
	public static synchronized DBConnection getConnection(int maxConnections, long waitTimeout, long idleTimeout, String DBMS, String jdbcDriver, String databaseURL, String userID, String password, String dbName) throws SQLException {
	 ...
	 * @exception SQLException
	 */
	public static DBConnection getConnection(String application) throws SQLException {
	 ...
	 * @exception SQLException
	 */
	public static DBConnection getConnection(String application, String name) throws SQLException {
	 ...
	 * @param passwd The password for the specified user.
	  */
	public static DBConnection getDirectConnection(String url, String driverName, String user, String passwd) throws SQLException {
	 ...
	 * @param passwd The password for the specified user.
	  */
	public static DBConnection getDirectConnection(String dbms, String url, String driverName, String user, String passwd) throws SQLException {
	 ...
	 * @param passwd The password for the specified user.
	  */
	public static DBConnection getDirectConnection(String dbms, String url, String driverName, String dbName, String user, String passwd) throws SQLException {
		try {

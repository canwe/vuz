...
/**
 * This class provides a storage buffer for data in SQL ResultSets for applets. The data is retrieved from a RemoteDataStore on a server via the DataServer servlet.

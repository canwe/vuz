...
/**
 * This class provides a storage buffer for data in SQL ResultSets that allow
 * for retreves, inserts updates and deletes.
 */
public class DataStore extends DataStoreBuffer implements Runnable, Serializable, DataStoreInterface {
	...
	private DataSourceIn _dsIn, _curDsIn;
	 ...
	 *            The sql to execute.
	 */
	public synchronized void buildBuffer(DBConnection conn, String sql) throws SQLException, DataStoreException {
		reset();
	 ...
	 *            The sql to execute.
	 */
	public synchronized void buildBuffer(String sql) throws SQLException, DataStoreException {
		if (_appName == null)
	 ...
	 *            The sql to execute.
	 */
	public synchronized void execute(DBConnection conn, String sql) throws SQLException {
	 ...
	 *            The sql to execute.
	 */
	public synchronized void execute(String sql) throws SQLException, DataStoreException {
		if (_appName == null)
			throw new DataStoreException("This version of execute requires an application name and/or dbprofile. You cannot call this method on a DataStore created with the no-args constructor");
	 ...
	 */
	public synchronized void executeProc(DBConnection conn, String proc) throws SQLException {
	 ...
	 *            pass to the proc.
	 */
	public synchronized void executeProc(DBConnection conn, String proc, StoredProcedureParms parms) throws SQLException {
	...
	public void executeProc(String proc) throws SQLException, DataStoreException {
	 ...
	 *            pass to the proc.
	 */
	public synchronized void executeProc(String proc, StoredProcedureParms parms) throws SQLException, DataStoreException {
		if (_appName == null)
			throw new DataStoreException("This version of execute requires an application name and/or dbprofile. You cannot call this method on a DataStore created with the no-args constructor");
	 ...
	 */
	public void retrieve() throws SQLException, DataStoreException {
	 ...
	 *            The database connection to use to perform this operation.
	 */
	public void retrieve(DBConnection conn) throws SQLException, DataStoreException {
		String st = null;
		retrieve(conn, st);
	}
	 ...
	 * (not the no args constructor).
	 */
	public synchronized void retrieve(String criteria) throws SQLException, DataStoreException {
		DBConnection conn = null;
		if (_dbConn == null) {
			if (_appName == null)
				throw new DataStoreException("This version of retrieve requires an application name and/or dbprofile. You cannot call this method on a DataStore created with the no-args constructor");
	 ...
	 *            the prepared statement parameters for the criteria.
	 */
	public synchronized void retrieve(String criteria, PreparedStatementParms psp) throws SQLException, DataStoreException {
		DBConnection conn = null;
		if (_dbConn == null) {
			if (_appName == null)
				throw new DataStoreException("This version of retrieve requires an application name and/or dbprofile. You cannot call this method on a DataStore created with the no-args constructor");
	 ...
	 */
	public void union(DataStore dataStores[]) throws SQLException, DataStoreException {
		if (_appName == null)
	 ...
	 */
	public void union(DataStore dataStore) throws SQLException, DataStoreException {
	 ...
	 *            The array of data stores to union result sets together.
	 */
	public void union(DBConnection conn, DataStore dataStores[]) throws SQLException {
		reset();
	 ...
	 *            The datastore to union with this one.
	 */
	public void union(DBConnection conn, DataStore dataStore) throws SQLException, DataStoreException {
		DataStore d[] = new DataStore[1];
		d[0] = dataStore;
		union(conn, d);
	}
	 ...
	 *                If a SQLError occurs while the datastore is updating.
	 */
	public void update(DBConnection conn) throws DataStoreException, SQLException {
		update(conn, false);
	}
	 ...
	 */
	public synchronized void executePrepStmt(DBConnection conn, String stmt) throws SQLException {
	 ...
	 */
	public synchronized void executePrepStmt(DBConnection conn, String stmt, PreparedStatementParms parms) throws SQLException {
	...
	public void executePrepStmt(String stmt) throws SQLException, DataStoreException {
	 ...
	 *            pass to the proc.
	 */
	public synchronized void executePrepStmt(String stmt, PreparedStatementParms parms) throws SQLException, DataStoreException {
		if (_appName == null)
			throw new DataStoreException("This version of execute requires an application name and/or dbprofile. You cannot call this method on a DataStore created with the no-args constructor");
	...
	public void loadConnectionParms(DBConnection conn) {
		...
		if (val != null) {
			...
			try {
				java.util.Date d = df.parse(val);
				setNullDefault(DATATYPE_DATETIME, new Timestamp(d.getTime()));
			} catch (ParseException ex) {
		...
		if (val != null) {
			...
			try {
				java.util.Date d = df.parse(val);
				setNullDefault(DATATYPE_TIME, new Time(d.getTime()));
			} catch (ParseException ex) {

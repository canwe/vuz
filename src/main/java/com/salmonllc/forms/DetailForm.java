...
/**
 * Implements Detail form.
 * A display box is created containing a table with entry fields.  Also created are submit
 * buttons as follows:<BR>
 * - "Delete": the current row is removed from the database. <BR>
 * - "Save": the database is updated with the contents of the current row. <BR>
 * The form is implemented as a container to go within an instance of (a subclass of)
 * HtmlPage.  Specify as many data store columns as you want using the addColumn* methods. <BR>
 ...
 * should explicitly specify the primary keys.  For example, <BR>
 <PRE>
 ...
 */
public HtmlText getErrorMessageComp() {
 ...
 */
public void setErrorMessageComp(HtmlText newErrorMessageComp) {

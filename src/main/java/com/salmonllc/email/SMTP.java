...
public class SMTP implements Runnable {
    ...
    public Properties _fieldSMTPServers;
    public jakarta.mail.Session _mailSession;
...
*/
public Properties getSMTPServers() {
 ...
 */
public void setSMTPServers(Properties newSMTPServers) {

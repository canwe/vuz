 ...
 * @author: Fred Cahill
 */
public class SalmonDateFormat extends SimpleDateFormat {
 ...
 */
public SalmonDateFormat(String pattern, DateFormatSymbols formatData) {
 ...
 */
public SalmonDateFormat(String pattern, Locale loc) {
	super(pattern, loc);
}
/**

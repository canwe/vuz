...
public static Calendar AbrahamLincolnsBirthday (int nYear){
...
public static Calendar ChristmasDay (int nYear){
    ...
    public static Calendar ColumbusDayObserved (int nYear)
	{
...
*/
    ...
    public static Calendar GoodFridayObserved(int nYear)
	{
...
public static Calendar Halloween (int nYear){
	int nMonth = 9;
	// October 31st
    ...
    public static Calendar IndependenceDay (int nYear)
	{
	int nMonth = 6; // July
	// July 4th
...
public Calendar MartinLutherKingObserved (int nYear){
...
public static Calendar USElectionDay (int nYear){
...
public static Calendar ValentinesDay (int nYear){
	int nMonth = 1; // February
	// February 14th

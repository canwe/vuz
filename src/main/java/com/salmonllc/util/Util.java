...
public class Util
{
    ...
    public static Date getDateObject(int iYear, int iMonth, int iDay, int iHour, int iMinute)
    {
        ...
        Date sqlDate = new Date(greCal.getTime().getTime());
                ...
                switch (colType)
                {
                    ...
                    case DataStore.DATATYPE_DATE:
                        ...
                        else
                        {
                            ...
                            {
                                ds.setDate(row, colName, (Date) defaultVal);
                            }
                            else
                            {
                    ...
                    case DataStore.DATATYPE_DATETIME:
                        ...
                        {
                            if (defaultVal instanceof Timestamp)
                            {
                                ds.setDateTime(row, colName, (Timestamp) defaultVal);
                            }
                            else
                            {
                    ...
                    case DataStore.DATATYPE_TIME:
                        ...
                        {
                            if (defaultVal instanceof Time)
                            {
                                ds.setTime(row, colName, (Time) defaultVal);
                            }
                            else
                            {
     ...
     */
    public static Date timeToDate(Timestamp timeStampToConvert)
    {
		Date sqlDate =null;
    	if ( !Util.isNull(timeStampToConvert ))
    	{
			sqlDate = new Date(timeStampToConvert.getTime());
    	}
     ...
     * @return int
     */
    public static int getDaysElapsed(Timestamp compDate)
    {
        long currentMillis;
        long compareMillis;

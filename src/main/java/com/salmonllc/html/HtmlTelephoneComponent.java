...
public class HtmlTelephoneComponent extends HtmlFormComponent
{
    ...
    protected HtmlTextEdit _editAreaCode, _editPhoneStart, _editPhoneEnd;

    private HtmlText _txtAreaCodeStart;
    private HtmlText _txtAreaCodeEnd;
    private HtmlText _txtSeparator;

    private String _sAreaCode, _sPhoneStart, _sPhoneEnd;
    private String _sPhoneSeparator, _sAreaCodeStart, _sAreaCodeEnd;
     ...
     * @return java.lang.String
     */
    public String getPhoneSeparator() {
...
public void setDisabledFontStartTag(String tag)
{
     ...
     */
    public void setPhoneSeparator(String newPhoneSeparator) {

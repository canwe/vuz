...
/////////////////////////
//$Archive: /sofia/sourcecode/com/salmonllc/html/HtmlTabFolder.java $
//$Author: Deepak $
//$Revision: 21 $
//$Modtime: 10/31/03 11:54a $
/////////////////////////
import java.util.*;
import com.salmonllc.properties.*;

/**
 * This type implements a navigation bar which resembles a tab folder.  Each tab entry contains a display
...
public class HtmlTabFolder extends HtmlComponent {
    ...
    private String _bgColor, _bgColorActive;		// Background colors
    private String _tabImageLeft, _tabImageRight;
    private String _tabImageBorder;
    private String _tabFontStartTag, _tabFontEndTag, _tabFontActiveStartTag,
    _tabFontActiveEndTag;
    private int _height;

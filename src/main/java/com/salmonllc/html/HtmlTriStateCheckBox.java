 ...
 */
public HtmlTriStateCheckBox(String name, HtmlPage p, String checkedValue, String unCheckedValue,String mixedCheckedValue) {
 ...
 * @param Mixed Checked Value A string representation that will be returned from getValue() when the checkbox is mixed checked.
 */
public HtmlTriStateCheckBox(String name, String theme, HtmlPage p, String checkedValue, String unCheckedValue, String mixedCheckedValue) {
	super(name,theme,p);

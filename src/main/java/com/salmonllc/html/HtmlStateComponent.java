...
/**
 * Implements a drop down list that allows the user to select US states, Canadian Provinces or countries.
 * The name "state" is historical; it oringally only supported US states.
 */
public class HtmlStateComponent extends HtmlFormComponent
{
	...
	protected static final int LIST_STATES = 0, LIST_PROVINCES = 1, LIST_STATEPROV = 2, 
		LIST_PROVSTATE = 3, LIST_CANUSA = 4, LIST_COUNTRIES = 5;

...
/////////////////////////
//$Archive: /SOFIA/SourceCode/com/salmonllc/html/HtmlDropDownList.java $
//$Author: Srufle $
//$Revision: 49 $
...
public class HtmlDropDownList extends HtmlFormComponent implements PageListener
{
     ...
     */
    public HtmlDropDownList(String name, HtmlPage p)
    {
        this(name, null, p);
    }
     ...
     * @param p The page the component will be placed in.
     */
    public HtmlDropDownList(String name, String theme, HtmlPage p)
    {
        super(name, theme, p);
    }

...
/////////////////////////
//$Archive: /SOFIA/SourceCode/com/salmonllc/html/HtmlFormattedEntryComponent.java $
//$Author: Dan $ 
//$Revision: 8 $ 
//$Modtime: 10/20/03 3:43p $ 
/////////////////////////
...
/**
 * This object creates text edit boxes to accept formated input like invoice number, Tax id etc...
...
public class HtmlFormattedEntryComponent extends HtmlFormComponent
{
	...
	public String _sStr, _sSeparator;

...
/////////////////////////
//$Archive: /SOFIA/SourceCode/com/salmonllc/html/HtmlListBox.java $
//$Author: Dan $
//$Revision: 31 $
//$Modtime: 4/12/04 3:19p $
/////////////////////////
...
public class HtmlListBox extends HtmlFormComponent {
	 ...
	 */
	public HtmlListBox(String name, HtmlPage p) {
		this(name, null, p);
	}
	 ...
	 * @param p The page the component will be placed in.
	 */
	public HtmlListBox(String name, String theme, HtmlPage p) {
		super(name, theme, p);
	}

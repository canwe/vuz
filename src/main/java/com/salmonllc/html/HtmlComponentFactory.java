...
/**
 * This class can be used to reduce the coding involved in creating a data entry or data browsing screen. The methods in the factory will create the components and automatically bind them to columns in a DataStore, creating the DataStore in the process. Each component must then be added to the page.
 * The datastore component created by the factory can be accessed via a call to the getDataStore method.
 */

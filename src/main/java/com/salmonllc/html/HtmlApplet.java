...
public class HtmlApplet extends HtmlComponent {
    ...
    String _code,_codeBase, _archive,_alt,_align,_object,_title;
    String _width = "-1", _height = "-1", _hSpace = "-1", _vSpace = "-1";
    String _mayScript="false";
    Hashtable _parms;
    int _sizeOption = SIZE_PIXELS;
    String _value,_state;
    String _interactWithForm = "false";
    String _usePlugin="false";
    String _pluginClassId="clsid:8AD9C840-044E-11D1-B3E9-00805F499D93",_pluginCodeBase="http://java.sun.com/products/plugin/1.3/jinstall-13-win32.cab#Version=1,3,0,0";
     ...
     */
    public HtmlApplet(String name, String className, HtmlPage p) {
        super(name, p);
        _code = className;
        p.addApplet(this);
    }
     ...
     * @param p The page the applet will go in.
     */
    public HtmlApplet(String name, String className, String codeBase, int width, int height, HtmlPage p) {
     ...
     * @param p The page the applet will go in.
     */
    public HtmlApplet(String name, String className, String codeBase, int width, int height, String jarFile, HtmlPage p) {
        this(name, className, codeBase, p);
        _width = ""+width;
        _height = ""+height;
        _archive = jarFile; 
     ...
     * @param p The page the applet will go in.
     */
    public HtmlApplet(String name, String className, String codeBase, HtmlPage p) {

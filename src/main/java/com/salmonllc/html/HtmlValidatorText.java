...
/**
 * This is a special type of text component used in conjunction with the
...
public class HtmlValidatorText extends HtmlComponent implements SubmitListener, ValueChangedListener {
	...
	private int _breaksBefore, _breaksAfter;
	...
	/**
	 * @see HtmlComponent#generateHTML(PrintWriter, int)
	 */
	...
	/**
	 * @see HtmlComponent#processParms(Hashtable, int)
	 */
	...
	/**
	 * @see HtmlComponent#executeEvent(int)
	 */

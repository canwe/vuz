...
/**
 * This class is the ancestor of all JSP controllers. A subclass of this object
 ...
 * com.jspImplementation.ControllerSubClass. <BR>
...
public class JspController extends HtmlPage implements Constants {
	...
	public synchronized int doPost(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		HttpServletResponseWrapper w = (HttpServletResponseWrapper) getCurrentResponse();
	...
	public void generateScriptHtml(JspWriter p) throws Exception {
		if (_script != null) {
			p.println(_script);
			_script = null;
		}

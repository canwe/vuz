...
/////////////////////////
//$Archive: /SOFIA/SourceCode/com/salmonllc/jsp/JspNavBar.java $
//$Author: Srufle $
//$Revision: 130 $
//$Modtime: 8/05/04 5:22p $
/////////////////////////
import java.util.*;
...
public class JspNavBar extends JspContainer implements Constants, java.io.Serializable
{
    ...
    public void contractAllGroups()
    {
        ...
        {
            MessageLog.writeErrorMessage("ERROR:Contract All Groups", e, this);
            e.printStackTrace();
        }
    }
    ...
    public void expandAllGroups()
    {
        ...
        {
            MessageLog.writeErrorMessage("ERROR:Expand All Groups", e, this);
            e.printStackTrace();
        }
    }

...
public class JspList extends JspContainer implements ImageGenerator {
    ...
    private String _width,_colWidth;
    private String _fieldType = TYPE_NEWSPAPER;
    private int _border = 0,_cellPadding = 0,_cellSpacing = 0;
     ...
     */
    public JspList(String name, HtmlPage p) {
        this(name, null, p);
    }
     ...
     * JspList constructor comment.
     */
    public JspList(String name, String theme, HtmlPage p) {
        super(name, p);
        setTheme(theme);
     ...
     */
    public void generateHTML(TagWriter t, Vector content) throws IOException {
     ...
     */
    public void setDataStore(DataStoreBuffer newDataStore) {
        _ds = newDataStore;
    }

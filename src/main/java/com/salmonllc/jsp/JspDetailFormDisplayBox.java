...
public class JspDetailFormDisplayBox extends JspFormDisplayBox implements SubmitListener {
	...
	private String _okToAddQuestion = "Warning, adding a new item will cause unsaved changes to be lost. Continue?";
	private String _okToEditQuestion = "Warning, editing this item will cause unsaved changes to be lost. Continue?";
	private String _okToDeleteQuestion = "Confirm Delete?";
	private String _okToCancelQuestion = "Are you sure you want to cancel these changes?";
	private String _dirtyDataError = "Can't do save. The row has already been modified or deleted by another user. Please reload the data and try your changes again. ";
	...
	public JspDetailFormDisplayBox(String name, String theme, HtmlPage page) {
		...
		_deleteButton = new HtmlSubmitButton(name + "cancelButton", "Delete", theme, page);
		_cancelButton = new HtmlSubmitButton(name + "deleteButton", "Cancel", theme, page);

...
/////////////////////////
//$Archive: /SOFIA/SourceCode/com/salmonllc/jsp/controller/DetailFormController.java $
//$Author: Dan $
//$Revision: 29 $
...
/**
 * DetailFormController creates a detailform and binds its components to the
...
{
	public JspDetailForm _mainCont;
	private int flags = 0;

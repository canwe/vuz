...
public class FormBinder extends DataBinder
{
     ...
     */
    public DetailForm bindDetailForm(DetailForm detailForm, BaseDetailController page)
    {
                    ...
                    else
                    {
                        ...
                        { // create active only checkbox
                            ...
                            if (params != null)
                            {
                                ...
                                {
                                    String propertyName = en.nextElement().toString();
     ...
     * @return com.salmonllc.forms.ListForm
     */
    public ListForm bindListForm(ListForm ls, BaseListController page, String querystring)
    {
     ...
     */
    private String createFulColumnName(String table, String column)
    {

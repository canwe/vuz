...
/**
 * Base class for all the standard Detail Controllers.
 */
public class BaseDetailController extends JspController implements DetailFormListener, PageListener, SubmitListener
{
    ...
    public HtmlComponent fieldMessageComponent;
    /**
     ...
     * @return com.salmonllc.html.HtmlComponent
     */
    protected HtmlComponent getMessageComponent() {
     ...
     */
    public boolean onDetailError(int code, String message, HtmlComponent component)
    {
     ...
     */
    public boolean postDetailDelete() throws Exception {
        return true;
    }
    /**
     ...
     */
    public boolean postDetailRequest() throws Exception
    {
     ...
     */
    public boolean postDetailSave() throws Exception
    {
     ...
     * @return boolean	True if processing is to continue.
     */
    public boolean preDetailDelete() throws Exception {
        return true;
    }
    /**
     ...
     */
    public boolean preDetailRequest() throws Exception
    {
     ...
     * @return boolean	True if continue to save, else do not continue.
     */
    public boolean preDetailSave() throws Exception
    {
        var hashComp = getUserComponents();
        var en = hashComp.elements();
     ...
     */
    public void setMessageComponent(HtmlComponent newMessageComponent) {

...
/////////////////////////
//$Archive: /SOFIA/SourceCode/com/salmonllc/jsp/engine/JspConverter.java $
//$Author: Srufle $
//$Revision: 45 $
//$Modtime: 10/26/04 3:54p $
/////////////////////////
import java.util.*;
import java.io.*;
...
/**
 * This class can be used to process a simple JSP page and transform it into
 ...
 *		DREAMWEAVER: convert the page to DreamWeaver HTML (custom tags are wrapped in <MMBeginLock> <MMEndLock> tags)
 */
...
public class JspConverter {
	 ...
	 */
	public static void convertDocument(InputStream in, Servlet serv, ServletRequest req, ServletResponse res, int convType) throws Exception {
	 ...
	 * @param convType int valid values are: CONV_HTML: convert the page to standard HTML<BR> or CONV_DREAMWEAVER: convert the page to DreamWeaver HTML (custom tags are wrapped in <MMBeginLock> <MMEndLock> tags).
	 */
	public static void getInstanceVariables(InputStream in, Servlet serv, ServletRequest req, ServletResponse res, int convType, String docBase) throws Exception {

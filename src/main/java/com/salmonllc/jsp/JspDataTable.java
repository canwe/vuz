...
public class JspDataTable extends JspContainer implements ImageGenerator {
    ...
    public JspDataTable(String name, HtmlPage p) {
        this(name, null, p);
    }

    public JspDataTable(String name, String theme, HtmlPage p) {
        super(name, p);
        setTheme(theme);
     ...
     */
    public void generateHTML(TagWriter t, String content) throws IOException {
        _didSubmit = false;

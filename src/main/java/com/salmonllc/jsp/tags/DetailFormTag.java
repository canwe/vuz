...
public class DetailFormTag extends BaseEmptyTag
{
     ...
     */
    public void setCancelbutton(String new_cancelbutton)
    {
     ...
     */
    public void setCaption(String new_caption)
    {
     ...
     */
    public void setDatadef(String new_datadef)
    {
     ...
     */
    public void setDeletebutton(String new_deletebutton)
    {
     ...
     */
    public void setSavebutton(String new_savebutton)
    {

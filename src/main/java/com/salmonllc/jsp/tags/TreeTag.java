...
public class TreeTag extends BaseBodyTag
{
    ...
    */
     ...
     */
    public void setBuffer(TreeBuffer newBuffer)
    {
     ...
     */
    public void setContractimage(String newContractimage)
    {
     ...
     */
    public void setExpandimage(String newExpandimage)
    {
     ...
     */
    public void setNullimage(String newNullimage)
    {
     ...
     */
    public void setSelectmode(String newSelectmode)
    {
     ...
     */
    public void setShowroot(String newShowroot)
    {
     ...
     */
    public void setTreemode(String newTreemode)
    {

...
public class JspListFormDisplayBox extends JspFormDisplayBox implements SubmitListener {
    ...
    private String _validatorName, _detailFormName, _searchFormName;
    ...
    private HtmlSubmitButton _addButton, _saveButton;
    ...
    private String _saveButtonAccessKey, _addButtonAccessKey, _saveButtonCaption, _addButtonCaption;
    ...
    private String _lookupReturnExpString, _lookupReturnDescExpString;
        ...
        if (_datatable != null) {
            for (int i = 0; i < _datatable.getComponentCount(); i++) {
                ...
                if (_datatable.getComponentType(i) == JspContainer.TYPE_ROW && o instanceof JspTableRow) {
                    ...
                    var en = ((JspContainer) o).getComponents();
                    while (en.hasMoreElements()) {
                        o = en.nextElement();

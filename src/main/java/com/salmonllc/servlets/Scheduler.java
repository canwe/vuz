...
/**
 * This servlet is the controller for all the scheduled object in the framework.
 * <BR>
 * Each scheduled object must implement the com.salmonllc.ScheduledObject
 * interface and must be listed in the properties file. When the scheule
 * interval is reached a new instance of the object will be created and the
 * schedule reached event will be executed.
 */

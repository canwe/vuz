...
/**
 * This servlet is the entry point for all servlet based pages in the framework.
 * JSP Pages do not use it.<BR>
 * It will handle get and post calls from the browser and direct them to the appropriate
 * com.salmonllc.html.HtmlPage class<BR>
 ...
 * <BR>
 * The page should be a subclass of com.salmonllc.html.HtmlPageBase and should reside in a package
 * named with the following convention:<BR>
...
public class AppServer extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        //pw.flush();
        //pw.close();
        JspServlet.addPageHit(System.currentTimeMillis() - time);
    }
    ...
    private HtmlPageBase getPage(HttpServletRequest req, HttpServletResponse res) throws Exception {
        ...
        String path = "vuz" + "/" + req.getPathInfo();

...
<salmon:page controller="com.itm.vuz.vocabularies.controllers.CountryController"/> <!---->
...
<salmon:form name="pageForm">
    ...
    <!--Page Content End-->
    <salmon:datasource name="HibernateCountryDatasource" type="MODEL"
                       model="com.itm.vuz.vocabularies.models.HibernateCountryModel" autoretrieve="Never">
    </salmon:datasource>

    <salmon:box name="box1" width="50%">

        <salmon:searchformdisplaybox width="100%" name="searchformdisplaybox1" caption="Поиск Стран"
            ...
            <table border="0" width="100%">
                <tr>
                    <td width="200"><salmon:text name="searchEditCAP" text="Название страны" font="ColumnCaptionFont"/></td>
        ...
        <table width="100%" bgcolor="#cccccc" border="0">
            <tr>
                <td valign="top" width="60%">
                    ...
                    <salmon:listformdisplaybox name="l" mode="Display_single_page" caption="Страны" width="100%"
                                               addbuttonvisible="True" savebuttonvisible="True"
                                               datasource="HibernateCountryDatasource"
                                               searchformdisplaybox="searchformdisplaybox1" visible="false">
                        <salmon:datatable name="datatable1" width="100%" datasource="HibernateCountryDatasource"><salmon:datatableheader>
                                <salmon:tr>
                                    <salmon:td>
                                        <salmon:text name="countriesCAP" text="Название" font="TableHeadingFont"/>
                                    </salmon:td>
                                </salmon:tr>
                            </salmon:datatableheader><salmon:datatablerows>
                            <salmon:tr>
                                <salmon:td>
                                    <salmon:text name="countries" text="Country.name Goes Here" font="DefaultFont"
                                                 datasource="HibernateCountryDatasource:Country.name"/>
                                </salmon:td>
                            </salmon:tr>
                ...
                <td valign="top" width="40%"> <!--Detail Form-->
                    <salmon:box name="box4" width="100%">
                        ...
                        <salmon:detailformdisplaybox name="d" caption="Страна" width="100%" addbuttonvisible="True"
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td><salmon:text name="countryCAP" text="Название" font="ColumnCaptionFont"/></td>
                                <td><salmon:input type="text" name="country" size="16" maxlength="30"
                                                  datasource="HibernateCountryDatasource:Country.name"></salmon:input></td>
                            </tr>
                        </table>

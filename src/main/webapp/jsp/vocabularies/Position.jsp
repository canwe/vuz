...
<salmon:page controller="com.itm.vuz.vocabularies.controllers.PositionController"/>
...
<salmon:form name="pageForm">
    ...
    <!--Page Content End-->
    <salmon:datasource name="HibernatePositionDatasource" type="MODEL"
                       model="com.itm.vuz.vocabularies.models.HibernatePositionModel" autoretrieve="Never">
    </salmon:datasource>

    <salmon:box name="box1" width="50%">

        <salmon:searchformdisplaybox width="100%" name="searchformdisplaybox1" caption="Поиск Должности"
            ...
            <table border="0" width="100%">
                <tr>
                    <td width="200"><salmon:text name="searchEditCAP" text="Наименование должности" font="ColumnCaptionFont"/></td>
        ...
        <table width="100%" bgcolor="#cccccc" border="0">
            <tr>
                <td valign="top" width="50%">
                    ...
                    <salmon:listformdisplaybox name="l" mode="Display_single_page" caption="Должности" width="100%"
                                               addbuttonvisible="True" savebuttonvisible="True"
                                               datasource="HibernatePositionDatasource"
                                               searchformdisplaybox="searchformdisplaybox1" visible="false">
                        <salmon:datatable name="datatable1" width="100%" datasource="HibernatePositionDatasource">
                            <salmon:datatableheader>
                                <salmon:tr>
                                    <salmon:td>
                                        <salmon:text name="positionsCAP" text="Наименование" font="TableHeadingFont"/>
                                    </salmon:td>
                                </salmon:tr>
                            </salmon:datatableheader><salmon:datatablerows>
                            <salmon:tr>
                                <salmon:td>
                                    <salmon:text name="positions" text="Position.name Goes Here" font="DefaultFont"
                                                 datasource="HibernatePositionDatasource:Position.name"/>
                                </salmon:td>
                            </salmon:tr>
                ...
                <td valign="top" width="50%"> <!--Detail Form-->
                    <salmon:box name="box4" width="100%">
                        ...
                        <salmon:detailformdisplaybox name="d" caption="Должность" width="100%" addbuttonvisible="True"
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td><salmon:text name="positionCAP" text="Наименование" font="ColumnCaptionFont"/></td>
                                <td><salmon:input type="text" name="position" size="16" maxlength="30"
                                                  datasource="HibernatePositionDatasource:Position.name"></salmon:input></td>
                            </tr>
                        </table>

...
<salmon:page controller="com.itm.vuz.vocabularies.controllers.SettlementDifinitionController"/>
...
<salmon:form name="pageForm">
    ...
    <!--Page Content End-->
    <salmon:datasource name="HibernateSettlementDefinitionDatasource" type="MODEL"
                       model="com.itm.vuz.vocabularies.models.HibernateSettlementDefinitionModel" autoretrieve="Never">
    </salmon:datasource>

    <salmon:box name="box1" width="50%">

        <salmon:searchformdisplaybox width="100%" name="searchformdisplaybox1" caption="Поиск Типа поселения"
            ...
            <table border="0" width="100%">
                <tr>
                    <td width="200"><salmon:text name="searchEditCAP" text="Наименование типа поселения" font="ColumnCaptionFont"/></td>
        ...
        <table width="100%" bgcolor="#cccccc" border="0">
            <tr>
                <td valign="top" width="50%">
                    ...
                    <salmon:listformdisplaybox name="l" mode="Display_single_page" caption="Типы поселений" width="100%"
                                               addbuttonvisible="True" savebuttonvisible="True"
                                               datasource="HibernateSettlementDefinitionDatasource"
                                               searchformdisplaybox="searchformdisplaybox1" visible="false">
                        <salmon:datatable name="datatable1" width="100%" datasource="HibernateSettlementDefinitionDatasource">
                            <salmon:datatableheader>
                                <salmon:tr>
                                    <salmon:td>
                                        <salmon:text name="countriesCAP" text="Наименование" font="TableHeadingFont"/>
                                    </salmon:td>
                                </salmon:tr>
                            </salmon:datatableheader><salmon:datatablerows>
                            <salmon:tr>
                                <salmon:td>
                                    <salmon:text name="definitions" text="SettlementDefinition.name Goes Here" font="DefaultFont"
                                                 datasource="HibernateSettlementDefinitionDatasource:SettlementDefinition.name"/>
                                </salmon:td>
                            </salmon:tr>
                ...
                <td valign="top" width="50%"> <!--Detail Form-->
                    <salmon:box name="box4" width="100%">
                        ...
                        <salmon:detailformdisplaybox name="d" caption="Тип поселения" width="100%" addbuttonvisible="True"
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td><salmon:text name="definitionCAP" text="Наименование" font="ColumnCaptionFont"/></td>
                                <td><salmon:input type="text" name="definition" size="16" maxlength="25"
                                                  datasource="HibernateSettlementDefinitionDatasource:SettlementDefinition.name"></salmon:input></td>
                            </tr>
                        </table>

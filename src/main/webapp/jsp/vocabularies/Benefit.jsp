...
<salmon:page controller="com.itm.vuz.vocabularies.controllers.BenefitController"/>
...
<salmon:form name="pageForm">
    ...
    <!--Page Content End-->
    <salmon:datasource name="HibernateBenefitDatasource" type="MODEL"
                       model="com.itm.vuz.vocabularies.models.HibernateBenefitModel" autoretrieve="Never">
    </salmon:datasource>

    <salmon:box name="box1" width="50%">

        <salmon:searchformdisplaybox width="100%" name="searchformdisplaybox1" caption="Поиск Льгот"
            ...
            <table border="0" width="100%">
                <tr>
                    <td width="200"><salmon:text name="searchEditCAP" text="Наименование льготы" font="ColumnCaptionFont"/></td>
        ...
        <table width="100%" bgcolor="#cccccc" border="0">
            <tr>
                <td valign="top" width="50%">
                    ...
                    <salmon:listformdisplaybox name="l" mode="Display_single_page" caption="Льготы" width="100%"
                                               addbuttonvisible="True" savebuttonvisible="True"
                                               datasource="HibernateBenefitDatasource"
                                               searchformdisplaybox="searchformdisplaybox1" visible="false">
                        <salmon:datatable name="datatable1" width="100%" datasource="HibernateBenefitDatasource"><salmon:datatableheader>
                                <salmon:tr>
                                    <salmon:td>
                                        <salmon:text name="benefitsCAP" text="Наименование" font="TableHeadingFont"/>
                                    </salmon:td>
                                </salmon:tr>
                            </salmon:datatableheader><salmon:datatablerows>
                            <salmon:tr>
                                <salmon:td>
                                    <salmon:text name="benefits" text="Benefit.name Goes Here" font="DefaultFont"
                                                 datasource="HibernateBenefitDatasource:Benefit.name"/>
                                </salmon:td>
                            </salmon:tr>
                ...
                <td valign="top" width="50%"> <!--Detail Form-->
                    <salmon:box name="box4" width="100%">
                        ...
                        <salmon:detailformdisplaybox name="d" caption="Льгота" width="100%" addbuttonvisible="True"
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td><salmon:text name="benefitCAP" text="Наименование" font="ColumnCaptionFont"/></td>
                                <td><salmon:input type="text" name="benefit" size="16" maxlength="50"
                                                  datasource="HibernateBenefitDatasource:Benefit.name"></salmon:input></td>
                            </tr>
                        </table>

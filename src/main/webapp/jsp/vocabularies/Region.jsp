...
<salmon:page controller="com.itm.vuz.vocabularies.controllers.RegionController"/>
...
<salmon:form name="pageForm">
    ...
    <!--Page Content End-->
    <salmon:datasource name="HibernateRegionDatasource" type="MODEL"
                       model="com.itm.vuz.vocabularies.models.HibernateRegionModel" autoretrieve="Never">
    </salmon:datasource>
	<salmon:datasource name="HibernateCountryModel" type="MODEL"
                       model="com.itm.vuz.vocabularies.models.HibernateCountryModel" autoretrieve="Never">
    </salmon:datasource>

    <salmon:box name="box1" width="50%">

        <salmon:searchformdisplaybox width="100%" name="searchformdisplaybox1" caption="Поиск Региона"
        ...
        <table width="100%" bgcolor="#cccccc" border="0">
            <tr>
                <td valign="top" width="50%">
                    ...
                    <salmon:listformdisplaybox name="l" mode="Display_single_page" caption="Регионы" width="100%"
                                               addbuttonvisible="True" savebuttonvisible="True"
                                               datasource="HibernateRegionDatasource"
                                               searchformdisplaybox="searchformdisplaybox1" visible="false">
                        <salmon:datatable name="datatable1" width="100%" datasource="HibernateRegionDatasource">
                            <salmon:datatableheader>
                                <salmon:tr>
									...
									<salmon:td>
                                        <salmon:text name="countriesCAP" text="Страна" font="TableHeadingFont"/>
                                    </salmon:td>
                                </salmon:tr>
                            </salmon:datatableheader><salmon:datatablerows>
                            <salmon:tr>
                                <salmon:td>
                                    <salmon:text name="regions" text="Region.region Goes Here" font="DefaultFont"
                                                 datasource="HibernateRegionDatasource:Region.name"/>
                                </salmon:td>
								<salmon:td>
                                    <salmon:text name="countries" text="Region.country.name Goes Here" font="DefaultFont"
                                                 datasource="HibernateRegionDatasource:Region.country.name"/>
                                </salmon:td>
                            </salmon:tr>
                ...
                <td valign="top" width="50%"> <!--Detail Form-->
                    <salmon:box name="box4" width="100%">
                        ...
                        <salmon:detailformdisplaybox name="d" caption="Регион" width="100%" addbuttonvisible="True"
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td><salmon:input type="text" name="region" size="16" maxlength="50"
                                                  datasource="HibernateRegionDatasource:Region.name"></salmon:input></td>
                            </tr>
							<tr>
                                <td><salmon:text name="countryCAP" text="Страна" font="ColumnCaptionFont"/></td>
                                <td><salmon:input type="select" name="countrySelect" size="16" multiple="False"
 										datasource="HibernateRegionDatasource:Region.country.countryId">
 									</salmon:input>
								</td>
                            </tr>
                        </table>
